...
A formal [grammar](edn.ebnf) for [edn](https://github.com/edn-format/edn) in EBNF.
...
Copyright Rich Hickey and Kirill Chernyshov.

## Changelog

* Jan, 2026 - initial EBNF grammar contributed by Kirill Chernyshov
* Jan, 2026 - initial publication
